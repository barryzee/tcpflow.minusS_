...
replay<-
	function(mov,hand1,hand2,manualUpdateProbs,TTS_ALL,TTS_BASIC,SLEEP) {
		...
		for(hand in hand1:hand2) {
			output.dir=playWholeHandDriverPassParams(manualUpdateProbs=manualUpdateProbs,dir="/Volumes/Lacie_mini_2TB/tcpflow.minusS_//tcpflow.out01_07_2023_09_42_05.subd/processed__01_07_2023_09_57_47.subdir",hand=hand,game="hearts",suit.trump="",leader.firstTrick=0,pass.direction="l",TTS_ALL=TTS_ALL,TTS_BASIC=TTS_BASIC,SLEEP=SLEEP)
...
replay(mov="/Volumes/Lacie_mini_2TB/tcpflow.minusS_//tcpflow.out01_07_2023_09_42_05.subd/miscellaneous/Screen_Recording_2023-01-07_at_09.42.07.mov",hand1=1,hand2=10,manualUpdateProbs=TRUE,TTS_ALL=FALSE,TTS_BASIC=FALSE,SLEEP=0)
