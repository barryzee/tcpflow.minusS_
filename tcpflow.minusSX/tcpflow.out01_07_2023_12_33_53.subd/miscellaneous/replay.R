...
replay(mov="/Volumes/Lacie_mini_2TB/tcpflow.minusS_//tcpflow.out01_07_2023_12_33_53.subd/miscellaneous/Screen_Recording_2023-01-07_at_12.33.56.mov",hand1=1,hand2=13,manualUpdateProbs=TRUE,TTS_ALL=FALSE,TTS_BASIC=FALSE,SLEEP=0)
